...
class caixaeconomica:
    ...
    def getdadosboleto(self,dados):
        ...
        boleto['conta_cedente'] = self.formata_numero(dados['conta_cedente'],11,0)
        boleto['conta_devente_dv'] = self.formata_numero(dados['conta_cedente_dv'],1,0)

        nnum = "%s%s" %(dados['inicio_nosso_numero'],self.formata_numero(dados['nosso_numero'],8,0))
        ...
        dv = self.digitoVerificador_barra("%s%s%s%s%s%s" %(dados['codigobanco'],
                                                           dados['nummoeda'],
                                                           fator_vencimento,
                                                           valor,
                                                           nnum,           
